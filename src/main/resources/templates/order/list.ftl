        ...
        <div class="container-fluid">
            <div class="row clearfix">
                ...
                <#list 1.. page.getTotalPages() as index>
                    ...
                    &lt;#&ndash;大于5页时将页数模糊化..只显示当前页附近的5条&ndash;&gt;
                        <#if index == currentPage>
                        <li class="disabled">
                            <a href="#">${index}</a>
                        </li>
                        <#elseif currentPage - index gte -2 && currentPage - index lte 2 >
                        <li>
...
<script>
    ...
    if('WebSocket' in window) {
        websocket = new WebSocket('ws://2017b882s1.imwork.net:25973/sell/webSocket');
    }else {
